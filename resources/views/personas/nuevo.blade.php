...
@section('content')
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('personas.lista') }}">Nuevo</a></li>
  </ol>
  <hr>
  <div class="row">
    <div class="col-12">
      ...
      <form action="{{ route('personas.registrar') }}" method="post">
        ...
        <div class="col-md-4">
          <label>Nombres</label>
          <input type="text" name="nombres" class="form-control form-control-sm" autocomplete="off" required>
        </div>
        <div class="col-md-6">
          <label>Direccion</label>
          <input type="text" name="direccion" class="form-control form-control-sm" autocomplete="off" required>
        </div>
        <div class="col-md-2">
