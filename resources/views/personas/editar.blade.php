    ...
    <div class="col-12">
      ...
      <form action="{{ route('personas.actualizar') }}" method="post">
        ...
        <div class="col-md-2">
          ...
          <input type="text" name="documento" class="form-control form-control-sm" autocomplete="off" value="{{ $persona->documento }}" required>
        </div>
        <div class="col-md-4">
          <label>Nombres</label>
          <input type="text" name="nombres" class="form-control form-control-sm" autocomplete="off" value="{{ $persona->nombres }}" required>
        </div>
        <div class="col-md-6">
          <label>Direccion</label>
          <input type="text" name="direccion" class="form-control form-control-sm" autocomplete="off" value="{{ $persona->direccion }}" required>
        </div>
        <div class="col-md-2">
          <label>Telefono</label>
          <input type="text" name="telefono" class="form-control form-control-sm" autocomplete="off" value="{{ $persona->telefono }}" required>
        </div>
        <div class="col-md-2">
          <label>Tipo</label>
